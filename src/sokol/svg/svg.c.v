...
pub struct Pass {
    internal_start_canary u32 = 0
    action PassAction
    attachments Attachments
    swapchain Swapchain
    label &u8
    internal_end_canary u32 = 0
}
pub struct Bindings {
    internal_start_canary u32 = 0
...
pub struct CommitListener {
    func  fn (voidptr) voidptr = unsafe { nil }
    user_data  voidptr
}
...
fn C.sg_setup(&Desc) voidptr
pub fn setup(desc Desc) voidptr {
    return C.sg_setup(&desc)
}
fn C.sg_shutdown() voidptr
pub fn shutdown() voidptr {
    return C.sg_shutdown()
}
fn C.sg_isvalid() bool
pub fn isvalid() bool {
    return C.sg_isvalid()
}
fn C.sg_reset_state_cache() voidptr
pub fn reset_state_cache() voidptr {
    return C.sg_reset_state_cache()
}
fn C.sg_push_debug_group(&u8) voidptr
pub fn push_debug_group(name string) voidptr {
    return C.sg_push_debug_group(vstring_to_cstring(name))
}
fn C.sg_pop_debug_group() voidptr
pub fn pop_debug_group() voidptr {
    return C.sg_pop_debug_group()
}
...
fn C.sg_destroy_buffer(Buffer) voidptr
pub fn destroy_buffer(buf Buffer) voidptr {
    return C.sg_destroy_buffer(buf)
}
fn C.sg_destroy_image(Image) voidptr
pub fn destroy_image(img Image) voidptr {
    return C.sg_destroy_image(img)
}
fn C.sg_destroy_sampler(Sampler) voidptr
pub fn destroy_sampler(smp Sampler) voidptr {
    return C.sg_destroy_sampler(smp)
}
fn C.sg_destroy_shader(Shader) voidptr
pub fn destroy_shader(shd Shader) voidptr {
    return C.sg_destroy_shader(shd)
}
fn C.sg_destroy_pipeline(Pipeline) voidptr
pub fn destroy_pipeline(pip Pipeline) voidptr {
    return C.sg_destroy_pipeline(pip)
}
fn C.sg_destroy_attachments(Attachments) voidptr
pub fn destroy_attachments(atts Attachments) voidptr {
    return C.sg_destroy_attachments(atts)
}
fn C.sg_update_buffer(Buffer, &Range) voidptr
pub fn update_buffer(buf Buffer, data Range) voidptr {
    return C.sg_update_buffer(buf, &data)
}
fn C.sg_update_image(Image, &ImageData) voidptr
pub fn update_image(img Image, data ImageData) voidptr {
    return C.sg_update_image(img, &data)
}
...
fn C.sg_begin_pass(&Pass) voidptr
pub fn begin_pass(pass Pass) voidptr {
    return C.sg_begin_pass(&pass)
}
fn C.sg_apply_viewport(int, int, int, int, bool) voidptr
pub fn apply_viewport(x int, y int, width int, height int, origin_top_left bool) voidptr {
    return C.sg_apply_viewport(x, y, width, height, origin_top_left)
}
fn C.sg_apply_viewportf(f32, f32, f32, f32, bool) voidptr
pub fn apply_viewportf(x f32, y f32, width f32, height f32, origin_top_left bool) voidptr {
    return C.sg_apply_viewportf(x, y, width, height, origin_top_left)
}
fn C.sg_apply_scissor_rect(int, int, int, int, bool) voidptr
pub fn apply_scissor_rect(x int, y int, width int, height int, origin_top_left bool) voidptr {
    return C.sg_apply_scissor_rect(x, y, width, height, origin_top_left)
}
fn C.sg_apply_scissor_rectf(f32, f32, f32, f32, bool) voidptr
pub fn apply_scissor_rectf(x f32, y f32, width f32, height f32, origin_top_left bool) voidptr {
    return C.sg_apply_scissor_rectf(x, y, width, height, origin_top_left)
}
fn C.sg_apply_pipeline(Pipeline) voidptr
pub fn apply_pipeline(pip Pipeline) voidptr {
    return C.sg_apply_pipeline(pip)
}
fn C.sg_apply_bindings(&Bindings) voidptr
pub fn apply_bindings(bindings Bindings) voidptr {
    return C.sg_apply_bindings(&bindings)
}
fn C.sg_apply_uniforms(u32, &Range) voidptr
pub fn apply_uniforms(ub_slot u32, data Range) voidptr {
    return C.sg_apply_uniforms(ub_slot, &data)
}
fn C.sg_draw(u32, u32, u32) voidptr
pub fn draw(base_element u32, num_elements u32, num_instances u32) voidptr {
    return C.sg_draw(base_element, num_elements, num_instances)
}
fn C.sg_end_pass() voidptr
pub fn end_pass() voidptr {
    return C.sg_end_pass()
}
fn C.sg_commit() voidptr
pub fn commit() voidptr {
    return C.sg_commit()
}
...
fn C.sg_dealloc_buffer(Buffer) voidptr
pub fn dealloc_buffer(buf Buffer) voidptr {
    return C.sg_dealloc_buffer(buf)
}
fn C.sg_dealloc_image(Image) voidptr
pub fn dealloc_image(img Image) voidptr {
    return C.sg_dealloc_image(img)
}
fn C.sg_dealloc_sampler(Sampler) voidptr
pub fn dealloc_sampler(smp Sampler) voidptr {
    return C.sg_dealloc_sampler(smp)
}
fn C.sg_dealloc_shader(Shader) voidptr
pub fn dealloc_shader(shd Shader) voidptr {
    return C.sg_dealloc_shader(shd)
}
fn C.sg_dealloc_pipeline(Pipeline) voidptr
pub fn dealloc_pipeline(pip Pipeline) voidptr {
    return C.sg_dealloc_pipeline(pip)
}
fn C.sg_dealloc_attachments(Attachments) voidptr
pub fn dealloc_attachments(attachments Attachments) voidptr {
    return C.sg_dealloc_attachments(attachments)
}
fn C.sg_init_buffer(Buffer, &BufferDesc) voidptr
pub fn init_buffer(buf Buffer, desc BufferDesc) voidptr {
    return C.sg_init_buffer(buf, &desc)
}
fn C.sg_init_image(Image, &ImageDesc) voidptr
pub fn init_image(img Image, desc ImageDesc) voidptr {
    return C.sg_init_image(img, &desc)
}
fn C.sg_init_sampler(Sampler, &SamplerDesc) voidptr
pub fn init_sampler(smg Sampler, desc SamplerDesc) voidptr {
    return C.sg_init_sampler(smg, &desc)
}
fn C.sg_init_shader(Shader, &ShaderDesc) voidptr
pub fn init_shader(shd Shader, desc ShaderDesc) voidptr {
    return C.sg_init_shader(shd, &desc)
}
fn C.sg_init_pipeline(Pipeline, &PipelineDesc) voidptr
pub fn init_pipeline(pip Pipeline, desc PipelineDesc) voidptr {
    return C.sg_init_pipeline(pip, &desc)
}
fn C.sg_init_attachments(Attachments, &AttachmentsDesc) voidptr
pub fn init_attachments(attachments Attachments, desc AttachmentsDesc) voidptr {
    return C.sg_init_attachments(attachments, &desc)
}
fn C.sg_uninit_buffer(Buffer) voidptr
pub fn uninit_buffer(buf Buffer) voidptr {
    return C.sg_uninit_buffer(buf)
}
fn C.sg_uninit_image(Image) voidptr
pub fn uninit_image(img Image) voidptr {
    return C.sg_uninit_image(img)
}
fn C.sg_uninit_sampler(Sampler) voidptr
pub fn uninit_sampler(smp Sampler) voidptr {
    return C.sg_uninit_sampler(smp)
}
fn C.sg_uninit_shader(Shader) voidptr
pub fn uninit_shader(shd Shader) voidptr {
    return C.sg_uninit_shader(shd)
}
fn C.sg_uninit_pipeline(Pipeline) voidptr
pub fn uninit_pipeline(pip Pipeline) voidptr {
    return C.sg_uninit_pipeline(pip)
}
fn C.sg_uninit_attachments(Attachments) voidptr
pub fn uninit_attachments(atts Attachments) voidptr {
    return C.sg_uninit_attachments(atts)
}
fn C.sg_fail_buffer(Buffer) voidptr
pub fn fail_buffer(buf Buffer) voidptr {
    return C.sg_fail_buffer(buf)
}
fn C.sg_fail_image(Image) voidptr
pub fn fail_image(img Image) voidptr {
    return C.sg_fail_image(img)
}
fn C.sg_fail_sampler(Sampler) voidptr
pub fn fail_sampler(smp Sampler) voidptr {
    return C.sg_fail_sampler(smp)
}
fn C.sg_fail_shader(Shader) voidptr
pub fn fail_shader(shd Shader) voidptr {
    return C.sg_fail_shader(shd)
}
fn C.sg_fail_pipeline(Pipeline) voidptr
pub fn fail_pipeline(pip Pipeline) voidptr {
    return C.sg_fail_pipeline(pip)
}
fn C.sg_fail_attachments(Attachments) voidptr
pub fn fail_attachments(atts Attachments) voidptr {
    return C.sg_fail_attachments(atts)
}
fn C.sg_enable_frame_stats() voidptr
pub fn enable_frame_stats() voidptr {
    return C.sg_enable_frame_stats()
}
fn C.sg_disable_frame_stats() voidptr
pub fn disable_frame_stats() voidptr {
    return C.sg_disable_frame_stats()
}
